...
export default async function ProductDetails({
  ...
  return (
    <div>
      <div className="relative w-full grid grid-cols-1 lg:grid-cols-2 lg:gap-8 ">
        <Link
        ...
        <div className="relative overflow-hidden rounded-lg h-[400px] mb-4 lg:mb-0 md:h-[600px] lg:h-[600px] w-full">
          <Image
